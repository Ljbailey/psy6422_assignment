...
```{r embed, out.width='100%', out.extra='style="border: none;"', echo = FALSE}
knitr::include_app('http://psyassessment.shinyapps.io/psy6422_assignment',
                height = "600px")
```

<iframe width='1000px' height='1000px' src='http://psyassessment.shinyapps.io/psy6422_assignment' allow="picture-in-picture" >
...
``` {r shiny, warning = FALSE, results= 'hide', eval = FALSE}
shinyApp(
